...
export default function UiUxBrandPage() {
  ...
  const [sandboxMode, setSandboxMode] = useState<"wireframe" | "tokens" | "hifi">("hifi");
  ...
  const capabilities = [
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122l.188-.188a1.75 1.75 0 00-2.474-2.474l-.188.188a1.75 1.75 0 002.474 2.474zM9.53 16.122L12 18.586l4.03-4.03m-9.06 1.566L5.03 14.18a1.75 1.75 0 012.474-2.474l.188.188A1.75 1.75 0 015.03 14.18z" />
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122l.188-.188a1.75 1.75 0 00-2.474-2.474l-.188.188a1.75 1.75 0 002.474 2.474z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M14.304 14.304a1.75 1.75 0 01-2.474 0l-1.121-1.12a1.75 1.75 0 010-2.475l1.12-1.12a1.75 1.75 0 012.475 0l1.12 1.12a1.75 1.75 0 010 2.474l-1.121 1.121z" />
          <path strokeLinecap="round" strokeLinejoin="round" d="M19.07 19.07a1.75 1.75 0 01-2.474 0l-1.121-1.12a1.75 1.75 0 010-2.475l1.12-1.12a1.75 1.75 0 012.475 0l1.12 1.12a1.75 1.75 0 010 2.474l-1.12 1.12z" />
        </svg>
      )
    },
  ];
      ...
      preview: (
        <div className="w-full h-full border border-slate-200 bg-slate-50/70 p-4 rounded-2xl flex flex-col justify-between text-[0.68rem] font-mono text-slate-500 shadow-inner relative overflow-hidden">
          ...
          <div className="flex justify-between items-center pb-2 border-b border-slate-200/60 relative z-10">
            <span className="font-extrabold text-[#1161ed]">◇ MAP_USER_ROUTE</span>
            <span className="text-[0.6rem] px-2 py-0.5 rounded bg-[#1161ed]/10 text-[#1161ed] border border-[#1161ed]/20 font-black animate-pulse">ACTIVE FLOW</span>
          </div>
          
          <div className="flex gap-2 items-center justify-center relative z-10">
            <span className="px-2.5 py-1.5 bg-white border border-slate-200 rounded-xl shadow-sm text-slate-600">Home Page</span>
            <span className="text-[#1161ed] font-black animate-ping text-[0.6rem]">➔</span>
            <span className="px-2.5 py-1.5 bg-[#1161ed] text-white rounded-xl shadow-[0_4px_10px_rgba(17,97,237,0.2)] font-black">Configure Service</span>
            <span className="text-slate-400">➔</span>
            <span className="px-2.5 py-1.5 bg-white border border-slate-200 rounded-xl shadow-sm text-slate-600">Estimate</span>
          </div>
      ...
      preview: (
        <div className="w-full h-full border border-slate-200 rounded-2xl bg-slate-50/70 p-4 flex flex-col gap-3 font-mono text-[0.68rem] text-slate-400 relative overflow-hidden shadow-inner">
          ...
          <div className="grid grid-cols-3 gap-3 flex-1 z-10">
            <div className="border border-dashed border-slate-300 rounded-xl flex items-center justify-center p-1 bg-white/40">Side Spec</div>
            <div className="col-span-2 border border-dashed border-[#1161ed]/30 rounded-xl flex flex-col justify-between p-3 bg-white/60">
              ...
              <div className="h-8 bg-[#1161ed]/5 border border-dashed border-[#1161ed]/20 rounded-lg flex items-center justify-center text-[#1161ed] text-[0.6rem] font-bold">Grid Anchor [W: 100%]</div>
            </div>
          </div>
        </div>
      )
      ...
      preview: (
        <div className="w-full h-full rounded-2xl bg-gradient-to-br from-[#080d19] to-[#162238] p-4 flex flex-col justify-between text-white relative overflow-hidden shadow-xl border border-white/5">
          ...
          <div className="flex justify-between items-center relative z-10">
            <span className="text-[0.62rem] uppercase tracking-widest text-[#3b82f6] font-extrabold">Studio Output</span>
            <div className="flex items-center gap-1">
              <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-ping" />
              <span className="text-[0.58rem] font-mono text-slate-400">SYNC_OK</span>
            </div>
          </div>

          <div className="my-auto relative z-10">
            <div className="text-[0.62rem] text-slate-400 uppercase tracking-wider mb-1 font-semibold">Active Gradient Shader</div>
            <div className="text-sm font-black tracking-tight mb-2">Neon Conversion Dashboard</div>
  ...
  return (
    <div className="bg-slate-50/60 min-h-screen text-slate-900 font-Outfit relative overflow-hidden pb-24">
      ...
      <div className="max-w-[1100px] mx-auto px-6 pt-16">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="rotate-180 transition-transform group-hover:-translate-x-0.5">
        ...
        <header className="mb-24 text-center md:text-left relative z-10">
          ...
          <h1 className="text-[2.5rem] sm:text-[4rem] font-black leading-[1.05] text-slate-900 tracking-tight mb-6 max-w-[850px]">
            High-Fidelity Interfaces & <span className="bg-gradient-to-r from-[#1161ed] via-[#3b82f6] to-[#8b5cf6] bg-clip-text text-transparent drop-shadow-sm">Brand Systems</span>
          </h1>
          
          <p className="text-[#64748B] text-base sm:text-lg lg:text-[1.08rem] leading-[1.8] max-w-[780px] font-medium">
            We blueprint immersive experiences, user pathways, atomic design tokens, and cohesive brand systems. We balance visual wow factor with frictionless usability.
          </p>
        </header>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
            <div>
              ...
              <p className="text-slate-500 text-xs sm:text-sm mt-1">
                Interact with the selectors below to view how figma wireframe models map directly to spacing variables and production-ready visual modules.
              </p>
            </div>
          ...
          <div className="w-full bg-[#05080f] border border-slate-800/80 rounded-[40px] p-6 sm:p-12 shadow-2xl relative overflow-hidden min-h-[460px] flex flex-col md:flex-row gap-10 items-center justify-between">
            ...
            <div className="w-full md:w-[330px] shrink-0 z-10 flex flex-col gap-4 font-mono text-[0.72rem] text-slate-400">
              <div className="pb-3 border-b border-slate-800 flex justify-between items-center">
                ...
                <span className="px-2.5 py-0.5 rounded bg-slate-900 border border-slate-800 text-[0.6rem] font-bold text-slate-500">v5.2 Engine</span>
              </div>
              ...
              <div className="p-5 rounded-3xl bg-slate-900/60 backdrop-blur-md border border-slate-800/80 flex flex-col gap-3.5 shadow-inner">
                <div className="flex justify-between items-center">
                  ...
                  <span className="px-2 py-0.5 rounded bg-slate-800 border border-slate-700/50 text-[#1161ed] font-bold">Interactive Viewport</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Border Radius Spec</span>
                  <span className="text-[#3b82f6] font-bold">{sandboxMode === "wireframe" ? "0px (Blueprint Square)" : "28px (Adaptive Glass)"}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Active Spacing Scale</span>
                  <span className="text-[#3b82f6] font-bold">{sandboxMode === "wireframe" ? "None (Unbound Layout)" : "4px/8px Core Grid Alignment"}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Background Style</span>
                  <span className="text-[#3b82f6] font-bold">{sandboxMode === "hifi" ? "Glassmorphism Mesh Shader" : sandboxMode === "tokens" ? "Slate-900 / Border Highlight" : "Static Transparent Grid"}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Active Colors State</span>
                  <span className="text-yellow-400 font-bold">{sandboxMode === "hifi" ? "Brand Gradient Blend" : sandboxMode === "tokens" ? "Tokens Palette" : "Draft-Gray Blueprint"}</span>
                </div>
              </div>
            ...
            <div className="w-full flex-1 flex items-center justify-center p-2 z-10">
              ...
              {/* Output Frame Mockup */}
              <div className={`w-full max-w-[420px] transition-all duration-500 p-8 ${
                ...
                {sandboxMode === "tokens" && (
                  <>
                    <div className="absolute top-0 left-1/2 -translate-y-1/2 bg-purple-500 text-white font-mono text-[0.58rem] px-2.5 py-0.5 rounded shadow-md z-20">w-full [100%]</div>
                    <div className="absolute left-0 top-1/2 -translate-x-1/2 bg-purple-500 text-white font-mono text-[0.58rem] px-2 py-0.5 rounded shadow-md z-20 rotate-90">r-28 [28px]</div>
                  </>
                )}
                    ...
                    {sandboxMode === "wireframe" ? (
                      ...
                      <>
                        <div className="flex flex-col">
                          <span className={`text-[0.62rem] font-mono tracking-[0.2em] uppercase ${sandboxMode === "tokens" ? "text-purple-400 font-bold" : "text-[#1161ed] font-black"}`}>Studio Viewport</span>
                          <span className="text-sm font-black tracking-tight mt-0.5">Custom Analytics</span>
                        </div>
                        <div className={`w-8.5 h-8.5 rounded-xl flex items-center justify-center font-bold text-xs shadow-sm ${sandboxMode === "tokens" ? "bg-purple-900/40 border border-purple-500/30 text-purple-300" : "bg-white/10 text-white"}`}>
                          SV
                        </div>
                      </>
                    )}
                  ...
                  {sandboxMode === "wireframe" ? (
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="relative border border-dashed border-purple-500/30 p-4 rounded-xl bg-purple-950/20">
                        <div className="absolute top-0 right-3 bg-purple-500 text-white text-[0.5rem] font-mono px-1 rounded shadow">gap-4 [16px]</div>
                        <span className="text-[0.65rem] text-purple-300 block mb-1 font-bold">Design Spacing Tokens</span>
                    ...
                    <div className="flex flex-col gap-5">
                      ...
                      <div className="p-5 rounded-2xl bg-slate-900/60 border border-white/5 flex flex-col justify-between relative overflow-hidden shadow-inner">
                        ...
                        <div className="flex justify-between items-center mb-3">
                          <span className="text-[0.68rem] font-bold text-slate-400 tracking-wider">Estimated Traffic Lift</span>
                          <span className="px-2 py-0.5 rounded-full bg-emerald-400/10 text-emerald-400 text-[0.58rem] font-black uppercase tracking-widest animate-pulse border border-emerald-400/10">Active (+18.2%)</span>
                        </div>
                        <span className="text-[1.9rem] font-black tracking-tight leading-none text-white">$62,810</span>
                        ...
                        <div className="mt-5 h-16 w-full relative">
                          <svg className="w-full h-full overflow-visible" viewBox="0 0 100 30" preserveAspectRatio="none">
                            ...
                            <circle cx="100" cy="2" r="3.5" fill="#8b5cf6" className="animate-ping" />
        ...
        <section className="mb-28 border-t border-slate-200/50 pt-16 relative">
          <div className="text-center mb-20 relative z-10">
            ...
            <p className="text-slate-500 text-sm max-w-[500px] mx-auto mt-2 leading-relaxed">
              We compile highly robust layout constructs and graphic systems tailored directly to your startup goals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {capabilities.map((cap, idx) => (
              ...
              >
                ...
                <div className={`h-[5px] w-full absolute top-0 left-0 bg-gradient-to-r ${cap.gradient} rounded-t-[32px]`} />
                ...
                <div>
                  ...
                  <span className="text-[0.62rem] font-black uppercase text-[#1161ed] tracking-[0.15em] mb-2 block">{cap.badge}</span>
                  <h3 className="text-[1.2rem] text-slate-900 mb-3 font-black group-hover:text-[#1161ed] transition-colors duration-300">{cap.title}</h3>
                  <p className="text-slate-500 leading-relaxed text-[0.82rem]">{cap.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="py-20 border-t border-slate-200/50 mb-24 relative">
          <div className="text-center mb-20 relative z-10">
            ...
            <p className="text-slate-500 text-sm max-w-[520px] mx-auto mt-2 leading-relaxed">
              Click each milestone phase below to review our specific activities, tools used, and structural preview deliverables.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-[1100px] mx-auto items-center relative z-10">
              ...
              {steps.map((step, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-11 h-11 rounded-2xl flex items-center justify-center shrink-0 transition-all duration-300 font-black text-sm shadow-sm ${
                      isActive 
                    ...
                    <div>
                      <span className="text-[0.62rem] font-bold uppercase tracking-widest text-[#64748B] block mb-0.5">{step.subtitle}</span>
                      <h4 className={`text-[0.98rem] font-black transition-colors ${isActive ? "text-[#1161ed]" : "text-slate-900 group-hover:text-[#1161ed]"}`}>{step.title}</h4>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="lg:col-span-7 z-10">
              <div className="bg-white rounded-[36px] border border-slate-200/40 p-8 shadow-[0_8px_30px_rgba(17,97,237,0.01)] min-h-[390px] flex flex-col justify-between relative group hover:shadow-[0_25px_50px_rgba(17,97,237,0.07)] hover:border-[#1161ed]/20 transition-all duration-500">
                ...
                <div>
                  <span className="text-[0.62rem] font-black tracking-widest text-[#1161ed] uppercase block mb-1">Methodology Stage {steps[activeStep].num}</span>
                  <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-3">{steps[activeStep].title}</h3>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-slate-100 text-[0.65rem] font-bold text-slate-400">
                  ...
                  {steps[activeStep].tools.map((tool, i) => (
                    <span key={i} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200/80 text-slate-600 rounded-lg transition-colors font-mono">{tool}</span>
                  ))}
                </div>
              </div>
            </div>
        ...
        <section className="relative rounded-[40px] bg-[#020713] p-10 sm:p-20 text-center text-white overflow-hidden shadow-2xl z-10 mt-16 max-w-[1100px] mx-auto border border-white/5">
          ...
          <div className="relative z-10 max-w-[650px] mx-auto">
            ...
            <p className="text-[#94A3B8] max-w-[540px] mx-auto text-[0.92rem] leading-relaxed mb-10 font-medium">
              Our UI/UX specialists are ready to architect responsive wireframe modules, custom variables guidelines, or interactive vector components.
            </p>
            <Link 
              href="/contact" 
