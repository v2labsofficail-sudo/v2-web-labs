    ...
    <div className="bg-white min-h-screen text-slate-900 font-Outfit relative overflow-hidden pb-24">
      ...
      <ScrollReveal>
        ...
        {stats.map((stat, idx) => (
          <div
            key={idx}
            className="group relative p-6 sm:p-8 rounded-[24px] border border-slate-200/80 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.03)] transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:border-[#0055DA]/30 hover:shadow-[0_20px_45px_rgba(0, 85, 218,0.08)] flex flex-col justify-center items-center text-center"
          >
            <div className="absolute top-0 left-0 right-0 h-[4px] bg-[#0055DA] hover:bg-[#0044B3] rounded-t-[24px] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      <ScrollReveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left">
            ...
            <h2 className="text-3xl sm:text-[2.2rem] font-black text-slate-900 tracking-tight leading-[1.1] mb-6">
          ...
          {/* Middle Column: Illustration representing scaling/ladders */}
          <div className="lg:col-span-3 flex justify-center items-center">
            <div className="relative w-full aspect-square max-w-[260px] rounded-[2rem] overflow-hidden shadow-lg border border-slate-200/50 bg-white">
              <Image
                src="/images/services/erp-crm.jpg"
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            {[
              ...
              <div
                key={idx}
                className="flex gap-4 p-5 rounded-2xl border border-slate-200/40 bg-white  shadow-sm hover:shadow-[0_15px_30px_rgba(17, 97, 237,0.06)] hover:border-[#111111]/20 hover:bg-white transition-all duration-300 relative group overflow-hidden"
              >
      ...
      <ScrollReveal>
        ...
        <div className="relative z-10 max-w-[650px] mx-auto">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-3.5 bg-[#0055DA] hover:bg-[#0044B3] shadow-[0_4px_20px_rgba(17, 97, 237,0.25)] hover:shadow-[0_8px_30px_rgba(17, 97, 237,0.4)] text-white font-extrabold rounded-full transition-all duration-300 hover:-translate-y-0.5 text-sm uppercase tracking-wider"
          >
            Initiate Estimate
          </Link>
        </div>
