      ...
      icon: (
        ...
        >
          <path
            ...
            d="M9.813 15.904L9 21m0 0l-.813-5.096L9 21zm0 0h4.906M12 3v1m6.364.364l-.707.707M21 12h-1M4 12H3m3.343-5.657l.707-.707m2.828 9.9a5 5 0 113.626 0"
          />
        </svg>
      ),
    },
      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M15.75 10.5V6a3.75 3.75 0 10-75 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"
          />
        </svg>
      ),
    },
      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M20.25 14.15v4.25c0 .621-.504 1.125-1.125 1.125H4.875A1.125 1.125 0 013.75 18.4V14.15m16.5 0a9.003 9.003 0 00-16.5 0m16.5 0c0-.18-.009-.36-.027-.539M3.75 14.15c0-.18.017-.36.053-.539m16.42 0a4.5 4.5 0 00-16.42 0"
          />
        </svg>
      ),
    },
        ...
        <ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {PROJECTS.map((proj, idx) => (
              <div
                key={idx}
                className="p-8 rounded-[32px] border border-slate-200/80 bg-white shadow-[0_10px_35px_rgba(15,23,42,0.03)] relative overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_25px_55px_rgba(0, 85, 218,0.08)] hover:border-[#0055DA]/30 group flex flex-col justify-between min-h-[360px]"
              >
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-5 bg-white  rounded-2xl border border-slate-200/40 shadow-[0_4px_12px_rgba(17, 97, 237,0.01)] hover:border-[#111111]/15 transition-all duration-300"
                  >
              ...
              <div className="relative rounded-[40px] bg-[#020713] p-8 sm:p-12 text-left text-white overflow-hidden shadow-2xl flex flex-col justify-between border border-white/5 w-full">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#94A3B8] text-[0.84rem] leading-relaxed mb-10 font-semibold">
                    Coordinate with our engineering and visual design studio to
                    launch high-performance digital products designed to scale
                    from prototype to CDN edge.
                  </p>
                </div>
                ...
                <div className="relative z-10 pt-4 border-t border-white/5">
                  <Link
                    href="/contact"
                    className="inline-flex w-full items-center justify-center py-4 bg-[#0055DA] hover:bg-[#0044B3] shadow-[0_6px_25px_rgba(17, 97, 237,0.3)] hover:shadow-[0_10px_35px_rgba(0,85,218,0.55)] text-white font-extrabold rounded-full transition-all duration-300 hover:-translate-y-0.5 text-xs uppercase tracking-widest"
                  >
                    Start Your Project
                  </Link>
                </div>
